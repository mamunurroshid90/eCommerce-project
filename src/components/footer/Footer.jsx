    ...
    <>
      <footer>
          ...
          <div className=" container max-w-screen-xl mx-auto py-10 px-3 ">
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 justify-items-center">
              ...
              <div className="">
                ...
                <ul className=" text-[#838383] font-bodyFont text-center mt-4 text-sm">
            ...
            <div className=" flex flex-col items-center gap-3 mt-10 border-y-[1px] border-[#3c3c3c] py-5">
              <p className=" text-xs text-[#838383] font-bodyFont">
        ...
        <div className=" bg-black">
          <div className="  flex flex-col items-center gap-2 py-5 font-bodyFont">
